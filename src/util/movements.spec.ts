  ...
  describe('movements', () => {
    describe('local to firebase', () => {
      it('replaces local date with UTC', () => {
        ...
        const forFirebase = localToFirebase(movement as any);
    ...
    describe('firebase to local', () => {
      it('replaces UTC with local date', () => {
        ...
        const local = firebaseToLocal(movement as any);
    ...
    describe('isLocked', () => {
      it('returns true if movement is before lock date', () => {
        ...
        expect(isLocked(movement as any, lockDate)).toBe(true);
      });
      ...
      it('returns true if movement is after lock date', () => {
        ...
        expect(isLocked(movement as any, lockDate)).toBe(false);
      });
    });
    ...
    describe('transferValues', () => {
      it('transfers values which are not undefined and not null', () => {
        ...
        transferValues(source, target as any, ['val1', 'val2', 'val3'] as any);
        ...
        expect((target as any).val3).toBe('foo');
      });
      ...
      it('takes default value if value is null or undefined', () => {
        ...
        transferValues(source, target as any, [{ name: 'val1', defaultValue: 0 }] as any);

        expect((target as any).val1).toBe(0);
      });
    });
  });
});
