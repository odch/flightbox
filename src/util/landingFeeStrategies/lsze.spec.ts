...
describe('util', () => {
  describe('landingFeeStrategies', () => {
    describe('lsze', () => {
        ...
        describe.each([
          ...
          (mtow, aircraftCategory, expected) => {
            test(`returns ${expected}`, () => {
              const landingFee = lsze.getLandingFee(mtow, undefined as any, undefined as any, aircraftCategory)
      ...
      describe('getVatRate ', () => {
        test('returns 8.1', () => {
          const vatRate = lsze.getVatRate(undefined as any, undefined as any, 'Flugzeug')
