      ...
      describe('sagas', () => {
        ...
        describe('add', () => {
          it('should resolve when set succeeds', async () => {
            ...
            (child as jest.Mock).mockReturnValue(mockChildRef);
          ...
          it('should reject when set fails', async () => {
            ...
            (firebase as jest.Mock).mockReturnValue(mockRef);
            (child as jest.Mock).mockReturnValue(mockChildRef);
            (set as jest.Mock).mockRejectedValue(new Error('permission denied'));
        ...
        describe('remove', () => {
          it('should resolve when remove succeeds', async () => {
            ...
            (firebase as jest.Mock).mockReturnValue(mockRef);
            (child as jest.Mock).mockReturnValue(mockChildRef);
            (fbRemove as jest.Mock).mockResolvedValue(undefined);
          ...
          it('should reject when remove fails', async () => {
            ...
            (firebase as jest.Mock).mockReturnValue(mockRef);
            (child as jest.Mock).mockReturnValue(mockChildRef);
            (fbRemove as jest.Mock).mockRejectedValue(new Error('remove failed'));
