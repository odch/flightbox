        ...
        it('should set loading flag', () => {
          expect(
            messages({
              ...
              loading: false,
              selected: null,
            } as any, actions.setMessagesLoading())
          ).toEqual({
            data: new ImmutableItemsArray([{
              key: 'msg1',
              text: 'text 1',
        ...
        it('should set selected message', () => {
          expect(
            messages({
              ...
              loading: false,
              selected: null,
            } as any, actions.selectMessage('msg1'))
          ).toEqual({
            data: new ImmutableItemsArray([{
              key: 'msg1',
              text: 'text 1',
        ...
        it('should unset selected message', () => {
          expect(
            messages({
              ...
              loading: false,
              selected: null,
            } as any, actions.selectMessage(null as any))
          ).toEqual({
            data: new ImmutableItemsArray([{
              key: 'msg1',
              text: 'text 1',
      ...
      describe('SAVE_MESSAGE_SUCCESS', () => {
        it('should set sent flag and clear commitFailed', () => {
          expect(
            ...
            } as any, actions.saveMessageSuccess())
          ).toEqual({
            form: {
              sent: true,
              commitFailed: false,
      ...
      describe('SAVE_MESSAGE_FAILURE', () => {
        it('should set commitFailed flag and clear sent', () => {
          expect(
            ...
            } as any, actions.saveMessageFailure())
          ).toEqual({
            form: {
              sent: false,
              commitFailed: true,
      ...
      describe('RESET_MESSAGE_FORM', () => {
        it('should reset form to initial state', () => {
          expect(
            ...
            } as any, actions.resetMessageForm())
          ).toEqual({
            form: {
              sent: false,
              commitFailed: false,
